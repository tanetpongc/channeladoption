...
dt_1_long <- data.table(
  cust = 1, #customerid
  week_nr = sample(200:300, n, replace = FALSE), #generate 50 random sequence number which is integer and range between 40 to 150 NO REPEATED WEEK
  spend = runif(n, min = 150, max = 1000), #generate 50 random numbers in R, which can be either integers or decimals (floating-point numbers), and fall within the range of 150 to 1000
  online = sample(c(0, 1), n, replace = TRUE), #generate 50 random numbers which can be either 0 or 1
  postal = 10000,
  volume = sample(6:100, n, replace = TRUE),
...
n = 30
  ...
  dt_2_short <- data.table(
    cust = 2, #customerid
    week_nr = sample(40:150, n, replace = FALSE), #generate 50 random sequence number which is integer and range between 40 to 150 NO REPEATED WEEK
    spend = runif(n, min = 100, max = 1000), #generate 50 random numbers in R, which can be either integers or decimals (floating-point numbers), and fall within the range of 150 to 1000
    online = 0, #offline
    postal = 20000,
...
dt_3_short <- data.table(
  cust = 3, #customerid
  week_nr = sample(40:150, n, replace = FALSE), #generate 50 random sequence number which is integer and range between 40 to 150 NO REPEATED WEEK
  spend = runif(n, min = 550, max = 2000), #generate 50 random numbers in R, which can be either integers or decimals (floating-point numbers), and fall within the range of 150 to 1000
  online = sample(c(0, 1), n, replace = TRUE), #generate 50 random numbers which can be either 0 or 1
  postal = 20000,
  volume = sample(6:100, n, replace = TRUE),
  plannedvol = sample(7:30, n, replace = TRUE),
...
dt_3_long <- data.table(
  cust = 3, #customerid
  week_nr = sample(200:300, n, replace = FALSE), #generate 50 random sequence number which is integer and range between 40 to 150 NO REPEATED WEEK
  spend = runif(n, min = 200, max = 1000), #generate 50 random numbers in R, which can be either integers or decimals (floating-point numbers), and fall within the range of 150 to 1000
  online = sample(c(0, 1), n, replace = TRUE), #generate 50 random numbers which can be either 0 or 1
  postal = 20000,
  volume = sample(6:100, n, replace = TRUE),
  plannedvol = sample(7:30, n, replace = TRUE),
...
dt_4_short <- data.table(
  cust = 4, #customerid
  week_nr = sample(40:150, n, replace = FALSE), #generate 50 random sequence number which is integer and range between 40 to 150 NO REPEATED WEEK
  spend = runif(n, min = 200, max = 2000), #generate 50 random numbers in R, which can be either integers or decimals (floating-point numbers), and fall within the range of 150 to 1000
  online = 0, #offline
  postal = 10000,
...
dt_5_short <- data.table(
  cust = 5, #customerid
  week_nr = sample(40:150, n, replace = FALSE), #generate 50 random sequence number which is integer and range between 40 to 150 NO REPEATED WEEK
  spend = runif(n, min = 450, max = 3000), #generate 50 random numbers in R, which can be either integers or decimals (floating-point numbers), and fall within the range of 150 to 1000
  online = sample(c(0, 1), n, replace = TRUE), #generate 50 random numbers which can be either 0 or 1
  postal = 20000,
...
dt_7_short <- data.table(
  cust = 7, #customerid
  week_nr = sample(40:150, n, replace = FALSE), #generate 50 random sequence number which is integer and range between 40 to 150 NO REPEATED WEEK
  spend = runif(n, min = 800, max = 3500), #generate 50 random numbers in R, which can be either integers or decimals (floating-point numbers), and fall within the range of 150 to 1000
  online = sample(c(0, 1), n, replace = TRUE), #generate 50 random numbers which can be either 0 or 1
  postal = 10000,
...
dt_8_short <- data.table(
  cust = 8, #customerid
  week_nr = sample(40:150, n, replace = FALSE), #generate 50 random sequence number which is integer and range between 40 to 150 NO REPEATED WEEK
  spend = runif(n, min = 200, max = 3000), #generate 50 random numbers in R, which can be either integers or decimals (floating-point numbers), and fall within the range of 150 to 1000
  online = 0, #offline
  postal = 10000,
  volume = sample(5:120, n, replace = TRUE),
  plannedvol = sample(1:10, n, replace = TRUE),
...
dt_8_long <- data.table(
  cust = 8, #customerid
  week_nr = sample(200:300, n, replace = FALSE), #generate 50 random sequence number which is integer and range between 40 to 150 NO REPEATED WEEK
  spend = runif(n, min = 300, max = 4000), #generate 50 random numbers in R, which can be either integers or decimals (floating-point numbers), and fall within the range of 150 to 1000
  online = 0, #offline
  postal = 10000,
  volume = sample(5:120, n, replace = TRUE),
  plannedvol = sample(1:10, n, replace = TRUE),
...
dt_9_long <- data.table(
  cust = 9, #customerid
  week_nr = sample(200:300, n, replace = FALSE), #generate 50 random sequence number which is integer and range between 40 to 150 NO REPEATED WEEK
  spend = runif(n, min = 700, max = 3000), #generate 50 random numbers in R, which can be either integers or decimals (floating-point numbers), and fall within the range of 150 to 1000
  online = sample(c(0, 1), n, replace = TRUE), #generate 50 random numbers which can be either 0 or 1
  postal = 20000,
...
dt_10_short <- data.table(
  cust = 10, #customerid
  week_nr = sample(40:150, n, replace = FALSE), #generate 50 random sequence number which is integer and range between 40 to 150 NO REPEATED WEEK
  spend = runif(n, min = 100, max = 3000), #generate 50 random numbers in R, which can be either integers or decimals (floating-point numbers), and fall within the range of 150 to 1000
  online = 0, #offline
  postal = 10000,
  volume = sample(20:90, n, replace = TRUE),
  plannedvol = sample(7:40, n, replace = TRUE),
...
dt_11_short <- data.table(
  cust = 11, #customerid
  week_nr = sample(40:150, n, replace = FALSE), #generate 50 random sequence number which is integer and range between 40 to 150 NO REPEATED WEEK
  spend = runif(n, min = 10, max = 100), #generate 50 random numbers in R, which can be either integers or decimals (floating-point numbers), and fall within the range of 150 to 1000
  online = 0, #offline
  postal = 10000,
...
dt_14_short <- data.table(
  cust = 14, #customerid
  week_nr = sample(40:150, n, replace = FALSE), #generate 50 random sequence number which is integer and range between 40 to 150 NO REPEATED WEEK
  spend = runif(n, min = 1000, max = 4000), #generate 50 random numbers in R, which can be either integers or decimals (floating-point numbers), and fall within the range of 150 to 1000
  online = 0, #offline
  postal = 10000,
